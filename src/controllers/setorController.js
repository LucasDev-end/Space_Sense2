...
function listar(req, res) {
    setorModel.listar().then(function (resultado) {
...
function listarGrafico2(req, res) {
    setorModel.listarGrafico2().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function listarGrafico3(req, res) {
    setorModel.listarGrafico3().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function listarGrafico4(req, res) {
    setorModel.listarGrafico4().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function listarGrafico5(req, res) {
    setorModel.listarGrafico5().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
